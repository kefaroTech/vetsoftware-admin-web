...
function line(overrides: Partial<SubscriptionItemResponse> = {}): SubscriptionItemResponse {
  return {
    ...
    discountPercent: 0,
    discountAmount: 0,
    discountIsConditional: false,
    taxRate: 19,
    // Sin descuento, la base imponible es el importe bruto. Con
    // `discountIsConditional: true` dejaría de serlo: ese es el caso que D-86 separa.
    taxableBase: 34000,
