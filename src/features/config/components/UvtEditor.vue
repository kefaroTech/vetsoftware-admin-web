    ...
    <div class="card">
      <div class="card-head">
        ...
        <div class="head-text">
          ...
          <div class="head-sub">Unidad de Valor Tributario vigente para facturación electrónica</div>
        </div>
      ...
      <div class="card-body">
        ...
        <template v-else>
          ...
          <div v-if="err" class="edit-err"><Icon :icon="ICONS.INFO" width="13" height="13" />{{ err }}</div>
          <div class="edit-actions">
            <button class="btn-save" :disabled="saving" @click="onSave">
              <Icon :icon="ICONS.CHECK" width="14" height="14" />{{ saving ? 'Guardando…' : 'Guardar cambios' }}
            </button>
      ...
      <div class="history">
        ...
        <div class="history-empty">
          Aún no se registran vigencias anteriores. El sistema mantiene el valor vigente del año en curso.
        </div>
      </div>
    </div>
      ...
      <div class="explain">
        ...
        <div class="explain-body">
          ...
          <p>
            ...
            para estandarizar valores tributarios. VetSoftware la usa para calcular topes y referencias
            en la <strong>facturación electrónica</strong>.
          </p>
        </div>
      </div>
      <div class="note">
        ...
        <div>
          ...
          <p>
            Actualiza este valor cada inicio de año con la cifra oficial publicada por la DIAN. Un valor
            incorrecto afecta directamente los cálculos de facturación.
          </p>
        </div>
      </div>
    </div>
...
.btn-edit {
  ...
  cursor: pointer;
  font-family: inherit;
  box-shadow: 0 4px 12px -2px rgba(126, 34, 206, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.15);
}
.edit-label {
  font-size: 12px;
  font-weight: 600;
